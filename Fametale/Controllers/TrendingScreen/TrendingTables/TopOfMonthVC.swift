...
class TopOfMonthVC: UIViewController {
    ...
    func trendingVideoList(){
        ...
        if InternetConnection.internetshared.isConnectedToNetwork() {
            ...
            WebserviceConnection.requestGETURL("trandingVideoByMonth", success: { (responseJson) in
...
//MARK:
extension TopOfMonthVC:UITableViewDelegate,UITableViewDataSource{
