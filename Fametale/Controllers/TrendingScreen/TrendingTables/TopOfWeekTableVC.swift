//
//  TopOfWeekTableVC.swift
//  Fametale
//
//  Created by Callsoft on 11/07/18.
...
class TopOfWeekTableVC: UIViewController {
    ...
    func trendingVideoList(){
        ...
        if InternetConnection.internetshared.isConnectedToNetwork() {
            ...
            WebserviceConnection.requestGETURL("trandingWeekVideo", success: { (responseJson) in
...
//MARK:
extension TopOfWeekTableVC:UITableViewDelegate,UITableViewDataSource{
